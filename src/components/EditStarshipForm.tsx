...
export const EditStarshipForm: FunctionComponent<EditStarshipComponentProps> = ({
  getInitialData,
  saveData,
}) => {
  ...
  const initialData =
    (id && getInitialData && getInitialData(id)) || new Starship();
  ...
  return (
    <>
      <Typography component="h3" variant="h6">
        {initialData.id ? 'Edit' : 'Add'} starship
      </Typography>
      <Box marginY={1}>
      ...
      <form noValidate onSubmit={formik.handleSubmit}>
        ...
        <TextField
          ...
          label="Cost"
          error={Boolean(
            formik.touched.cost_in_credits && formik.errors.cost_in_credits
          )}
          helperText={
            formik.touched.cost_in_credits && formik.errors.cost_in_credits
          }
